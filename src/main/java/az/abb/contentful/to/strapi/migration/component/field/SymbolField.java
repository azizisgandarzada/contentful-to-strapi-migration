...
@Component
public class SymbolField extends EntryField {

    @Override
    public EntryFieldType getType() {
        return EntryFieldType.SYMBOL;
    }
    ...
    public Object resolveValue() {
        return ContentfulUtils.getLocalizedValueOrDefault(getRawField(), getLocale(), getDefaultLocale()).asText();
    }
