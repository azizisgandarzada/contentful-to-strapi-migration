...
@Component
public class IntegerField extends EntryField {

    @Override
    public EntryFieldType getType() {
        return EntryFieldType.INTEGER;
    }
    ...
    public Object resolveValue() {
        return ContentfulUtils.getLocalizedValueOrDefault(getRawField(), getLocale(), getDefaultLocale()).asInt();
    }
